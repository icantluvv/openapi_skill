...
function Step({ description, ref, src, title }: Readonly<StepProps>) {
    return (
        <div
            className={`flex w-full flex-1 items-start gap-[14px] rounded-sm bg-background px-[14px] pt-[10px] pb-[20px] shadow-custom md:min-h-[208px] md:flex-col md:gap-[6px] md:px-[22px] md:pt-[20px] md:pb-[40px] xl:min-h-auto xl:flex-row xl:items-center xl:gap-[24px] xl:px-[24px] xl:py-[28px]`}
            ref={ref}
        >
