...
function SkeletonCard() {
    return (
        <li className="shadow-custom flex flex-row items-start justify-between rounded-sm p-[12px] pb-[24px] md:flex-col md:items-center md:justify-start md:p-[24px] md:pb-[48px]">
            ...
            <div className="flex flex-col items-center gap-[7px]">
                ...
                <div className="bg-light-gray flex rounded-sm p-[5px]">
                    <Skeleton></Skeleton>
                </div>
